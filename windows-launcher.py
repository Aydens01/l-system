...
nom_entree = str(input("nom fichier .txt d'entrée :"))
nom_sortie = str(input("nom fichier .py de sortie :"))
entree = open('rules/'+nom_entree+".txt","r")
sortie = open('orders/'+nom_sortie+".py","w")
...
os.system("python orders/"+str(nom_sortie)+".py")
